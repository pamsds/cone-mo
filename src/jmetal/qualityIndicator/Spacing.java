...
public class Spacing {
  ...
  /** 
   * Constructor.
   * Creates a new instance of a Spacing object 
   */
  public Spacing() {
  ...
  public static void main(String args[]) {
	if (args.length < 2) {
      System.err.println("Spacing::Main: Error using Spacing. Usage: \n java " +
			             "Spacing <FrontFile> <TrueFrontFile>  " +
		                 "<getNumberOfObjectives>");
      System.exit(1);
	} // if

	// STEP 1. Create a new instance of the metric
	Spacing qualityIndicator = new Spacing();
	...
	double value = qualityIndicator.spacing(solutionFront,trueFront,2);
